...
<div class="container my-5">
  ...
  <div class="row g-4">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://cdn.leroymerlin.com.br/products/dobradica_para_porta_com_rolamento_ate_25kg_3_pecas_88412730_0001_600x600.jpg" class="card-img-top" alt="Dobradiça Rolamentada Cromada">
        <div class="card-body">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://www.travaforte.com.br/image/cache/data/Produtos/KI/KIT-C-3-DOBRADIAS-INOX-ROLAMENTO-FERLOCK-3-5X3-PRETA-COR-NO-DEFINIDA-465B9A21-1-300x300.jpg.webp" class="card-img-top" alt="Dobradiça Rolamentada Black">
        <div class="card-body">
