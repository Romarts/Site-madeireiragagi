  ...
  <div class="row g-4">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://product-hub-prd.madeiramadeira.com.br/668072337/images/c310973c-f3fe-4332-aa1d-2e1d43e4ecd11440ab7f4355f95890f00b3f75.JPG?width=500&canvas=1:1&bg-color=FFF" class="card-img-top" alt="Batente 7,5cm">
        <div class="card-body">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://product-hub-prd.madeiramadeira.com.br/668072337/images/c310973c-f3fe-4332-aa1d-2e1d43e4ecd11440ab7f4355f95890f00b3f75.JPG?width=500&canvas=1:1&bg-color=FFF" class="card-img-top" alt="Batente 9,5cm">
        <div class="card-body">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://madermac.cdn.magazord.com.br/img/2025/03/produto/5165/batente-tauari-comercial-4.png?ims=fit-in/600x600/filters:fill(white)" class="card-img-top" alt="Batente 13cm">
        <div class="card-body">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://madermac.cdn.magazord.com.br/img/2025/03/produto/5165/batente-tauari-comercial-4.png?ims=fit-in/600x600/filters:fill(white)" class="card-img-top" alt="Batente 14cm">
        <div class="card-body">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://images.tcdn.com.br/img/img_prod/1111274/batente_em_tauari_90x210cm_requadro_15cm_madefort_241_2_5081b7bd985ec0945b3ee275dc6d94c5.jpeg" class="card-img-top" alt="Batente 15cm">
        <div class="card-body">
