  ...
  <div class="row g-4">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3">
      <div class="card h-100">
        <img src="https://cdn.leroymerlin.com.br/products/tijolo_a_vista_6_furos_9x14x24cm_ceramica_porto_galera_89088923_5090_600x600.jpg" class="card-img-top" alt="Tijolo 6 Furos">
        <div class="card-body">
